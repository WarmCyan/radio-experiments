...
# Title: Fancy Fm
# Description: Simple adjustable RX monitor, with a bit more functionality
...
class fancy_fm(gr.top_block, Qt.QWidget):

    def __init__(self):
        gr.top_block.__init__(self, "Fancy Fm")
        Qt.QWidget.__init__(self)
        self.setWindowTitle("Fancy Fm")
        ...
        self.settings = Qt.QSettings("GNU Radio", "fancy_fm")
...
def main(top_block_cls=fancy_fm, options=None):
